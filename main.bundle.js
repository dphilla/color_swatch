...
var $ = __webpack_require__(0);
var handlers = __webpack_require__(2);
var pojoService = __webpack_require__(11);
...
function addSwatches(input) {
  // would continue refactoring into helpers
  var colors = input.split(' ');
  colors = helpers.makeLowerCase(colors);
  var colorDict = _colors2.default;
  var colorKeys = Object.keys(colorDict);
  var uniqColors = colors.unique();
...
exports.makeLowerCase = makeLowerCase;
